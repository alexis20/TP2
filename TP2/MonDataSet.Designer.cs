...
namespace TP2 {
    ...
    public partial class MonDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientDataTable : global::System.Data.TypedTableBase<ClientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClientRow AddClientRow(string NomClient) {
        ...
        public partial class FactureDataTable : global::System.Data.TypedTableBase<FactureRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public FactureRow AddFactureRow(System.DateTime DateFacture, ClientRow parentClientRowByFK_Facture_Client) {
                ...
                if ((parentClientRowByFK_Facture_Client != null)) {
                    columnValuesArray[2] = parentClientRowByFK_Facture_Client[0];
                }
...
namespace TP2.MonDataSetTableAdapters {
    ...
    public partial class ClientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Client] WHERE (([IDClient] = @Original_IDClient) AND ((@IsNull" +
                "_NomClient = 1 AND [NomClient] IS NULL) OR ([NomClient] = @Original_NomClient)))" +
                "";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Client] ([NomClient]) VALUES (@NomClient);\r\nSELECT IDClient, N" +
                "omClient FROM Client WHERE (IDClient = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Client] SET [NomClient] = @NomClient WHERE (([IDClient] = @Original" +
                "_IDClient) AND ((@IsNull_NomClient = 1 AND [NomClient] IS NULL) OR ([NomClient] " +
                "= @Original_NomClient)));\r\nSELECT IDClient, NomClient FROM Client WHERE (IDClien" +
                "t = @IDClient)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TP2.Properties.Settings.Default.bdOperationConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IDClient, NomClient FROM dbo.Client";
        ...
        public virtual int Fill(MonDataSet.ClientDataTable dataTable) {
        ...
        public virtual MonDataSet.ClientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MonDataSet.ClientDataTable dataTable = new MonDataSet.ClientDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MonDataSet.ClientDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MonDataSet dataSet) {
        ...
        public virtual int Delete(int Original_IDClient, string Original_NomClient) {
        ...
        public virtual int Insert(string NomClient) {
            if ((NomClient == null)) {
        ...
        public virtual int Update(string NomClient, int Original_IDClient, string Original_NomClient, int IDClient) {
            if ((NomClient == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NomClient, int Original_IDClient, string Original_NomClient) {
            return this.Update(NomClient, Original_IDClient, Original_NomClient, Original_IDClient);
        }
    }
    ...
    public partial class FactureTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Facture] WHERE (([IDFacture] = @Original_IDFacture) AND ((@IsN" +
                "ull_DateFacture = 1 AND [DateFacture] IS NULL) OR ([DateFacture] = @Original_Dat" +
                "eFacture)) AND ([IDClient] = @Original_IDClient))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Facture] ([DateFacture], [IDClient]) VALUES (@DateFacture, @ID" +
                "Client);\r\nSELECT IDFacture, DateFacture, IDClient FROM Facture WHERE (IDFacture " +
                "= SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Facture] SET [DateFacture] = @DateFacture, [IDClient] = @IDClient WHERE (([IDFacture] = @Original_IDFacture) AND ((@IsNull_DateFacture = 1 AND [DateFacture] IS NULL) OR ([DateFacture] = @Original_DateFacture)) AND ([IDClient] = @Original_IDClient));
SELECT IDFacture, DateFacture, IDClient FROM Facture WHERE (IDFacture = @IDFacture)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT IDFacture, DateFacture, IDClient FROM dbo.Facture";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(MonDataSet.FactureDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual MonDataSet.FactureDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MonDataSet.FactureDataTable dataTable = new MonDataSet.FactureDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MonDataSet.FactureDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_IDFacture, global::System.Nullable<global::System.DateTime> Original_DateFacture, int Original_IDClient) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(global::System.Nullable<global::System.DateTime> DateFacture, int IDClient) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<global::System.DateTime> DateFacture, int IDClient, int Original_IDFacture, global::System.Nullable<global::System.DateTime> Original_DateFacture, int Original_IDClient, int IDFacture) {
            if ((DateFacture.HasValue == true)) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Original_IDFacture));
            if ((Original_DateFacture.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[4].Value = ((System.DateTime)(Original_DateFacture.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(IDFacture));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<global::System.DateTime> DateFacture, int IDClient, int Original_IDFacture, global::System.Nullable<global::System.DateTime> Original_DateFacture, int Original_IDClient) {
            return this.Update(DateFacture, IDClient, Original_IDFacture, Original_DateFacture, Original_IDClient, Original_IDFacture);
        }
    }
